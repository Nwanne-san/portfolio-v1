...
const Skills: React.FC = () => {
  return (
    <div>
      <div className="mx-auto bg-gradient-to-b block md:hidden  from-teal-500 rounded-full w-64 h-64 relative overflow-hidden hover:transform hover:scale-110 hover:duration-300 hover:ease-in md:h-96 md:w-96">
      ...
      <div className="flex flex-col text-center items-center justify-center mt-10 lg:mt-20 pb-7">
        ...
        <h1 className="dark:text-white text-teal-600 text-3xl md:text-4xl mb-2">
          Skills &amp; Technologies
        </h1>
      </div>
      <div className="flex flex-col w-full lg:flex-row gap-10 md:gap-20 justify-center items-center">
        ...
        <div>
          ...
          <div className="text-sm my-2 mb-4 text-white grid grid-cols-3 grid-rows-3 md:grid-rows-2 md:grid-cols-3 gap-2 md:min-w-[450px]">
          ...
          <div className="text-sm my-2 mb-4 text-white grid grid-cols-3  md:grid-rows-2 md:grid-cols-3 gap-2 md:min-w-[450px]">
